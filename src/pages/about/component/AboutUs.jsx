...
const AboutUs = () => {
  return (
    <Box bg={[`#def1f9`]} p={[`1rem 1rem`, `1rem 6rem`]} w={`100%`}>
      <Box
        marginRight={[`3rem`, `20rem`]}
        marginTop={[`1rem`, `7rem`]}
        w={`100%`}
      >
        <Flex justifyContent={[`space-around`]} alignContent={[`center`]}  gap={{base: `3rem`, lg: `0`}}>
          <Box  
          width={{ base: `70%`, lg: `50%`}}
          >
        ...
        <Flex justifyContent={[ `flex-start`,`flex-start`,`flex-start`,`space-around`]} alignItems={[`flex-start`, `flex-start`, `flex-start`,`center`]}  mt={{lg: `8rem`}} position={{lg: `relative`}}>
          ...
          <Box listStyleType={`none`} ml={{lg: `17rem`}} mt={{lg: `3rem`}} w={{lg: `58%`}} >
            <Heading
